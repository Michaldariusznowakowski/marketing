            ...
            <ul
                ...
                <li>
                    <a href="{{ route('ratings') }}"
                        class="@if (request()->routeIs('ratings')) text-orange-600 @endif block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-orange-700 md:p-0">Opinie</a>
                </li>
                <li>
                    <a href="{{ route('cart') }}">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="@if (request()->routeIs('cart')) stroke-orange-600 @endif stroke-gray-600 icon icon-tabler icon-tabler-basket"
