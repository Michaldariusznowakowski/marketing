...
<footer class="bg-white dark:bg-gray-900">
    <div class="w-full max-w-screen-xl mx-auto p-2">
        ...
        <span class="text-sm text-gray-500 dark:text-gray-400 block w-text-gray-500 sm:text-center">KawkaOn-Line &copy; 2023. All Rights Reserved.</span>
        <ul class="block w-full mt-3 mb-2 flex flex-wrap items-center mt-3 space-x-3 justify-center">
            <li class="rounded-2xl hover:bg-gray-300 p-1">
                ...
                <a href="{{ route('index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         class="stroke-gray-600 icon icon-tabler icon-tabler-brand-facebook"
            ...
            <li class="rounded-2xl hover:bg-gray-300 p-1">
                ...
                <a href="{{ route('index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         class="stroke-gray-600 icon icon-tabler icon-tabler-brand-twitter"
                         width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                         stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path
            ...
            <li class="rounded-2xl hover:bg-gray-300 p-1">
                ...
                <a href="{{ route('index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         class="stroke-gray-600 icon icon-tabler icon-tabler-brand-instagram" width="24" height="24"
        ...
        <span class="text-sm text-gray-500 dark:text-gray-400 block hover:underline sm:text-center"><a
                href="{{ route('orders') }}">Zamówienia - PseudoAdmin</a></span>
    </div>
</footer>
